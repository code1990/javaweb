...
public class FormAttachmentExample3 {
	public FormAttachmentExample3() {
		...
		FormAttachment formattachment1 = new FormAttachment(composite, 80);
		//FormAttachment formattachment1 = new FormAttachment(composite, 80,SWT.BOTTOM);
